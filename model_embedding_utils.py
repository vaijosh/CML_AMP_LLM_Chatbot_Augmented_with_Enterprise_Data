...
tokenizer = AutoTokenizer.from_pretrained('/Users/vjoshi/DevNotes/HACKATHON-2023/CML_AMP_LLM_Chatbot_Augmented_with_Enterprise_Data/models/embedding-model', local_files_only=True)
model = AutoModel.from_pretrained('/Users/vjoshi/DevNotes/HACKATHON-2023/CML_AMP_LLM_Chatbot_Augmented_with_Enterprise_Data/models/embedding-model', local_files_only=True)
